...
| 이벤트                       | 속성                                                                                                         | 시점                                                           |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------- |
| Scenario Talk Started        | talk_type, session_id, first_speaker, scenario_id?, is_retry?, topic_id?                                     | 세션 시작 성공                                                 |
...
| Scenario Talk Turn Completed | talk_type, session_id, scenario_id?, turn_index, input_type(voice\|text), char_count, utterance_duration_ms? | 발화 제출 성공                                                 |
...
| Scenario Talk Completed      | talk_type, session_id, scenario_id?, turn_count, speaking_duration_ms?, end_reason?                          | 서버가 완료 판정                                               |
| Scenario Talk Abandoned      | talk_type, session_id?, scenario_id?, turn_index                                                             | 중도 이탈 확정                                                 |
