...
export const CharacterStage = ({
  ...
  // flex-1 + min-h: 질문·답변이 길어지면 무대가 먼저 자리를 내주고(축소), 짧으면 넓게 채운다
  <div className="relative flex min-h-28 w-full flex-1 items-end justify-center overflow-hidden rounded-b-3xl border-b border-border bg-white pt-[max(env(safe-area-inset-top),8px)] shadow-lg shadow-black/5">
    ...
    >
      {/* 상체 — 흰 배경째로 무대에 얹혀 마주 서 있는 구도. 무대가 줄면 캐릭터도 같이 축소된다. Rive 캐릭터로 교체 예정 */}
